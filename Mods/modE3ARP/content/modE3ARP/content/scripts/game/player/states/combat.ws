...
state Combat in CR4Player extends ExtendedMovable 
{
	...
	entry function PerformEvade( playerEvadeType : EPlayerEvadeType, isRolling : bool )
	{
		...
		if ( evadeTarget )
		{
			...
			dodgeLeftOrRight = AngleNormalize180( AngleDistance( rawDodgeHeading, parent.GetHeading() ) ); //E3ARP
			...
			else
			{
				...
				else //E3ARP Start
				{
					...
					if ( ( parent.GetCurrentStateName() != 'CombatFists' && playerToRawAngleDiff < 30.f ) || ( parent.GetCurrentStateName() == 'CombatFists' && playerToRawAngleDiff < 90.f ) )
					{
					...
					else if ( parent.GetCurrentStateName() != 'CombatFists' && playerToRawAngleDiff < 120.f )
					{
		...
		//FillDodgePlaylists( isRolling ); //E3ARP
