...
{	
	...
	private editable	var	vaultHeight				: float;				default	vaultHeight				= 0.5f; //E3ARP 0.5f
	private editable	var	vaultHeightOffset		: float;				default	vaultHeightOffset		= 0.25f;
	private editable	var	vaultDistance			: float;				default	vaultDistance			= 0.75f; //E3ARP 0.55f
	private editable	var	vaultRadius				: float;				default	vaultRadius				= 0.6f; //E3ARP 0.4f
