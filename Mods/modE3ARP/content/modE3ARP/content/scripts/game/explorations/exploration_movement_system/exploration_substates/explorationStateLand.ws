...
class CExplorationStateLand extends CExplorationStateAbstract
{
	...
	private	  editable			var m_AutoSlopeAngleB		: float;		default	m_AutoSlopeAngleB			= 45.0f; //E3ARP 30.0f
	...
	{		
		...
		if( m_ExplorationO.m_CollisionManagerO.IsGoingDownSlopeInstant( 1 /*m_AutoRollSlopeCoefF*/ ) ) //E3ARP
		{
			m_RollIsSlopeB	= true;
